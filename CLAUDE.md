...
This project is indexed by GitNexus as **LibreCommander** (2388 symbols, 6769 relationships, 212 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
