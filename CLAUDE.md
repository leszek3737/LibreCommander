...
This project is indexed by GitNexus as **LibreCommander** (2845 symbols, 8455 relationships, 253 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
