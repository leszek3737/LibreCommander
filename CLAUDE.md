...
This project is indexed by GitNexus as **LibreCommander** (1896 symbols, 5591 relationships, 168 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
