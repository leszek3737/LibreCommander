...
This project is indexed by GitNexus as **LibreCommander** (2358 symbols, 6560 relationships, 210 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
