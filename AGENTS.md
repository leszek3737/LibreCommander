...
This project is indexed by GitNexus as **LibreCommander** (2821 symbols, 8648 relationships, 252 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
