...
This project is indexed by GitNexus as **LibreCommander** (2741 symbols, 8071 relationships, 244 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
