...
This project is indexed by GitNexus as **LibreCommander** (2571 symbols, 7400 relationships, 229 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
